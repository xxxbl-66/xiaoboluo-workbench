...
const iconPaths = {
  ...
  workspace: ['M3 7.5 12 3l9 4.5-9 4.5-9-4.5Z', 'M3 12.5 12 17l9-4.5', 'M3 17 12 21.5 21 17'],
  play: ['M7 4.5 19 12 7 19.5V4.5Z'],
  link: ['M10.5 13.5a4 4 0 0 0 5.7 0l3-3a4 4 0 1 0-5.7-5.7l-1 1', 'M13.5 10.5a4 4 0 0 0-5.7 0l-3 3a4 4 0 1 0 5.7 5.7l1-1'],
